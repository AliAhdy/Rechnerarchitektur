...
#c) Schreiben Sie Ihr Programm so um, dass der Algorithmus in einem Unterprogramm ausgef ?uhrt wird! Die
#Argumente sollen in den Registern r4 und r5  ?ubergeben werden, der R ?uckgabewert in Register r2.